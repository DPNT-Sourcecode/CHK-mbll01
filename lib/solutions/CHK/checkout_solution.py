...
def checkout(skus):
    ...
    for i in idxprod:
        ...
        #Offer B
            ...
            tcost = tcost + offer_type_b(cnt[i],2,45,cost[i])
        #Offer F
        elif i == 5:
        ...
        #Offer K
            ...
            tcost = tcost + offer_type_b(cnt[i],2,120,cost[i])
        #Offer P
        elif i == 15:
            tcost = tcost + offer_type_b(cnt[i],5,200,cost[i])
        #Offer Q
        elif i == 16:
            tcost = tcost + offer_type_b(cnt[i],3,80,cost[i])
        #Offer U
        elif i == 20:
